...
dbSPE.define_table('usuario_profesor',
                ...
                Field('dependencia','integer', requires=IS_IN_DB(dbSPE,'departamento.id', '%(nombre)s',error_message='Departamento no existe'),label="Dependencia"),
                Field('dedicacion','integer', requires=IS_IN_DB(dbSPE,'dedicacion.id', '%(nombre)s',error_message='Dedicación no existe'),label="Dedicación"),
                Field('categoria','integer', requires=IS_IN_DB(dbSPE,'categoria.id', '%(nombre)s',error_message='Categoria no existe'),label="Categoría"),
                ...
                Field('activo','integer',requires=IS_IN_SET({1:'activo',0:'no activo'}),default=False, label="Situación"),
