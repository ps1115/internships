...
dbSPE.define_table('carrera',
                Field('codigo','string',required=True, requires=[IS_LENGTH(4),IS_NOT_EMPTY(error_message='Campo Obligatorio'),IS_NOT_IN_DB(dbSPE, 'carrera.codigo',error_message=T('Carrera ya existe'))], ondelete='CASCADE', notnull=True, unique=True,label='Código'),
                ...
                Field('coordinacion','reference coordinacion', label="Coordinación"),
                primarykey=['codigo'],
